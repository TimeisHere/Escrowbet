...
const S={
  ...
  fBtn:{padding:"7px 12px",borderRadius:20,border:"1px solid #3a424d",background:"none",color:"#6b7a8a",fontSize:11,cursor:"pointer",minHeight:34,outline:"none",WebkitTapHighlightColor:"transparent",boxShadow:"none"},
